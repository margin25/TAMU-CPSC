...
// change all instances of TCP Request Channel to TCP Request Channel 
// change to the appropriate constructor 
// getopt, and a and r collect values into vars
//
#include <fstream>
#include <iostream>
#include <thread>
...
int main (int argc, char *argv[]) {
    ...
    cout << "address ip: " << addr_ip << endl;
	TCPRequestChannel* chan = new TCPRequestChannel(addr_ip,port_no);
    ...
    for (int i = 0; i < w; i++) {
        wchans[i] = new TCPRequestChannel(addr_ip,port_no);
    }
