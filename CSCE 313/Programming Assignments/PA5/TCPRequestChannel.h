...
private:
	...
	*/
    ...
    // struct addrinfo hints, *res; //hints is an addrinfo structure which specifies address family, type (and flags in case of server)
    // res is the returned linked list of address structures each representing an address with which the server will bind the socket
